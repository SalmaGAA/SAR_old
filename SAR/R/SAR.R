...
# Define Variables
# ==================
# Rm = Rate of mutation - scalar 
# Ng = Number of genes per section - 1-dim array of length = num of sections
# Nl = Number of loci per gene per section - 1-dim array of length = num of sections
# Psize = Starting popultaion size - scalar
# P = Population - 2-dim array with each row representing a bacterium genotype
# startingFitness: starting fitness  
# Rd = Rate of division vector with elements = current fitness of individual cells = fraction of fully mutated genes
# gen.interval = generation interval in minutes

##
## On avg a bacterium has 4,000,000 bp with about 3,000 genes
## This implies an avg of 4,000,000 / 3,000 = 1,333 bp per gene
##
